 ...
 * @author Rhinestone
 */
contract OtherHookMultiPlexer2 is IERC7579Hook, ERC7579ModuleBase, ERC7484RegistryAdapter {
        ...
        returns (bytes memory hookData)
    {
        ...
        hooks.join($config.sigHooks[HookType.DELEGATECALL].sigHooks[callDataSelector]);
